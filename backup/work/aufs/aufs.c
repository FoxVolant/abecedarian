...
static int aufs_create(struct inode *dir, struct dentry *dentr, int mode)
{
...
{
	return aufs_create_file(name, S_IFDIR | S_IRUGO | S_IXUGO, parent, NULL, NULL);
}
